...
You will need Node.js installed. We recommend using the latest LTS version.

### Installation

1. **Clone the repository:**
   ```bash
   git clone https://github.com/your-username/my-awrad-space.git
   ```
...
5. **Open in browser:**
   Open `http://localhost:5173` in your browser to view the app in action.
...
The output will be generated in the `dist` folder. You can test it locally using:
